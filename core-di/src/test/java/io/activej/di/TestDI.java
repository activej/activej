...
import io.activej.di.binding.DIException;
import io.activej.di.module.AbstractModule;
import io.activej.di.module.Module;
import io.activej.di.module.ModuleBuilder;
import io.activej.di.module.Modules;
import io.activej.di.util.Constructors.Constructor0;
...
import static io.activej.di.Qualifiers.named;
import static io.activej.di.module.Modules.combine;
import static io.activej.di.module.Modules.override;
import static io.activej.di.util.Utils.printGraphVizGraph;
...
public final class TestDI {
	...
	public void optionalProvidesParam() {
		Module module = ModuleBuilder.create()
				.scan(new Object() {
					@Provides
					String string(Integer integer, @io.activej.di.annotation.Optional Float f) {
	...
	public void abstractModuleToString() {
		...
		assertTrue(module.toString().startsWith("AbstractModule(at io.activej.di.TestDI.abstractModuleToString(TestDI.java:"));
		assertTrue(module2.toString().startsWith("MyModule(at io.activej.di.TestDI.abstractModuleToString(TestDI.java:"));
		assertTrue(module3.toString().startsWith("InheritedModule(at io.activej.di.TestDI.abstractModuleToString(TestDI.java:"));
		assertTrue(module4.toString().startsWith("GenericModule<String, Integer>(at io.activej.di.TestDI.abstractModuleToString(TestDI.java:"));
		assertTrue(module5.toString().startsWith("RenamedModule(at io.activej.di.TestDI.abstractModuleToString(TestDI.java:"));
	}
