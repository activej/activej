...
import io.activej.di.impl.*;
import io.activej.di.module.DefaultModule;
import io.activej.di.module.Module;
import io.activej.di.module.Modules;
import io.activej.di.util.MarkedBinding;
...
import static io.activej.di.binding.BindingGenerator.REFUSING;
import static io.activej.di.binding.BindingGenerator.combinedGenerator;
import static io.activej.di.binding.BindingTransformer.IDENTITY;
import static io.activej.di.binding.BindingTransformer.combinedTransformer;
import static io.activej.di.binding.BindingType.*;
import static io.activej.di.binding.Multibinder.ERROR_ON_DUPLICATE;
import static io.activej.di.binding.Multibinder.combinedMultibinder;
import static io.activej.di.impl.CompiledBinding.missingOptionalBinding;
import static io.activej.di.util.Utils.getScopeDisplayString;
import static io.activej.di.util.Utils.next;
import static java.util.Collections.emptyMap;
import static java.util.Collections.singleton;
import static java.util.stream.Collectors.toMap;

/**
 * Injector is the main working component of the ActiveJ DI.
 * <p>
