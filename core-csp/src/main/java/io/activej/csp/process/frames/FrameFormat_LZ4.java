...
public final class FrameFormat_LZ4 implements FrameFormat {
	...
	public static Builder builder() {
		return new FrameFormat_LZ4(LZ4Factory.fastestInstance()).new Builder();
	}

	public static Builder builder(LZ4Factory factory) {
		return new FrameFormat_LZ4(factory).new Builder();
	}

	public final class Builder extends AbstractBuilder<Builder, FrameFormat_LZ4> {
		private Builder() {}

		public Builder withHighCompression() {
			checkNotBuilt(this);
			FrameFormat_LZ4.this.compressionLevel = -1;
			return this;
		}
		...
		public Builder withCompressionLevel(int compressionLevel) {
			...
			FrameFormat_LZ4.this.compressionLevel = compressionLevel;
			return this;
		}

		@Override
		protected FrameFormat_LZ4 doBuild() {
			return FrameFormat_LZ4.this;
		}
	}
