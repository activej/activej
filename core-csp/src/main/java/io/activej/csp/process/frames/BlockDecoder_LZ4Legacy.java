...
public final class BlockDecoder_LZ4Legacy implements BlockDecoder {
	...
	private final ByteScanner_IntLe intLEScanner = new ByteScanner_IntLe();

	BlockDecoder_LZ4Legacy(LZ4FastDecompressor decompressor, Checksum checksum, boolean ignoreMissingEndOfStreamBlock) {
