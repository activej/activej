...
public final class SerializerDef_Int extends SerializerDef_Primitive implements SerializerDefWithVarLength {
	private final boolean varLength;

	public SerializerDef_Int() {
		this(true, false);
	}

	public SerializerDef_Int(boolean wrapped) {
		this(wrapped, false);
	}

	public SerializerDef_Int(boolean wrapped, boolean varLength) {
	...
	public SerializerDef ensureWrapped() {
		return new SerializerDef_Int(true, varLength);
	}
	...
	public SerializerDef ensureVarLength() {
		return new SerializerDef_Int(wrapped, true);
	}
}
