...
public final class SerializerDef_Set extends SerializerDef_RegularCollection {
	public SerializerDef_Set(SerializerDef valueSerializer) {
		this(valueSerializer, false);
	}

	private SerializerDef_Set(SerializerDef valueSerializer, boolean nullable) {
		super(valueSerializer, Set.class, Set.class, Object.class, nullable);
	}

	@Override
	protected SerializerDef doEnsureNullable(CompatibilityLevel compatibilityLevel) {
		return new SerializerDef_Set(valueSerializer, true);
	}
