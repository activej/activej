...
public final class SerializerDef_ByteBuffer extends AbstractSerializerDef implements SerializerDef_WithNullable {
	...
	public SerializerDef_ByteBuffer() {
		this(false);
	}

	public SerializerDef_ByteBuffer(boolean wrapped) {
		this.wrapped = wrapped;
		this.nullable = false;
	}

	private SerializerDef_ByteBuffer(boolean wrapped, boolean nullable) {
		this.wrapped = wrapped;
	...
	public SerializerDef ensureNullable(CompatibilityLevel compatibilityLevel) {
		...
		return new SerializerDef_ByteBuffer(wrapped, true);
	}
}
