...
public final class SerializerDef_Subclass extends AbstractSerializerDef implements SerializerDef_WithNullable {
	...
	public SerializerDef_Subclass(Class<?> dataType, LinkedHashMap<Class<?>, SerializerDef> subclassSerializers, int startIndex) {
	...
	private SerializerDef_Subclass(Class<?> dataType, LinkedHashMap<Class<?>, SerializerDef> subclassSerializers, boolean nullable, int startIndex) {
		checkSubclasses(subclassSerializers.keySet());
	...
	public SerializerDef ensureNullable(CompatibilityLevel compatibilityLevel) {
		...
		return new SerializerDef_Subclass(dataType, subclassSerializers, true, startIndex);
	}
