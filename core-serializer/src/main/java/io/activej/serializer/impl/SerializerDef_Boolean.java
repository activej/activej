...
public final class SerializerDef_Boolean extends SerializerDef_Primitive implements SerializerDef_WithNullable {
	...
	public SerializerDef_Boolean() {
		this(true);
	}

	public SerializerDef_Boolean(boolean wrapped) {
		this(wrapped, false);
	}

	public SerializerDef_Boolean(boolean wrapped, boolean nullable) {
	...
	public SerializerDef ensureWrapped() {
		return new SerializerDef_Boolean(true, nullable);
	}
	...
	public SerializerDef ensureNullable(CompatibilityLevel compatibilityLevel) {
		...
		return new SerializerDef_Boolean(wrapped, true);
	}
}
