...
public interface StreamCodec<T> extends StreamEncoder<T>, StreamDecoder<T> {
	...
	static <T1, T> StreamCodec<T> create(
		TupleConstructor1<T1, T> constructor1,
	...
	static <T1, T2, T> StreamCodec<T> create(
		TupleConstructor2<T1, T2, T> constructor2,
		Function<T, T1> getter1, StreamCodec<T1> codec1,
	...
	static <T1, T2, T3, T> StreamCodec<T> create(
		TupleConstructor3<T1, T2, T3, T> constructor3,
		Function<T, T1> getter1, StreamCodec<T1> codec1,
		Function<T, T2> getter2, StreamCodec<T2> codec2,
	...
	static <T1, T2, T3, T4, T> StreamCodec<T> create(
		TupleConstructor4<T1, T2, T3, T4, T> constructor4,
		Function<T, T1> getter1, StreamCodec<T1> codec1,
		Function<T, T2> getter2, StreamCodec<T2> codec2,
		Function<T, T3> getter3, StreamCodec<T3> codec3,
	...
	static <T1, T2, T3, T4, T5, T> StreamCodec<T> create(
		TupleConstructor5<T1, T2, T3, T4, T5, T> constructor5,
		Function<T, T1> getter1, StreamCodec<T1> codec1,
		Function<T, T2> getter2, StreamCodec<T2> codec2,
		Function<T, T3> getter3, StreamCodec<T3> codec3,
		Function<T, T4> getter4, StreamCodec<T4> codec4,
	...
	static <T1, T2, T3, T4, T5, T6, T> StreamCodec<T> create(
		TupleConstructor6<T1, T2, T3, T4, T5, T6, T> constructor6,
		Function<T, T1> getter1, StreamCodec<T1> codec1,
		Function<T, T2> getter2, StreamCodec<T2> codec2,
		Function<T, T3> getter3, StreamCodec<T3> codec3,
		Function<T, T4> getter4, StreamCodec<T4> codec4,
	...
	static <T> StreamCodec<T> create(TupleConstructorN<T> constructorN, List<CodecAndGetter<T, ?>> codecsAndGetters) {
