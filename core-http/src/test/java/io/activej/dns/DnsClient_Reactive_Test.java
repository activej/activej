...
@Ignore
public final class DnsClient_Reactive_Test {
	@ClassRule
	...
	public void setUp() {
		...
		cachedDnsClient = DnsClient_Cached.create(reactor, DnsClient_Reactive.create(reactor).withDnsServerAddress(LOCAL_DNS));
	}
