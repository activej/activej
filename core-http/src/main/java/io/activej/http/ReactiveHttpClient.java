...
public final class ReactiveHttpClient extends AbstractNioReactive
	...
	public ReactiveHttpClient withDnsClient(@NotNull AsyncDnsClient asyncDnsClient) {
		this.asyncDnsClient = asyncDnsClient;
		return this;
	}
	...
	public ReactiveHttpClient withSocketInspector(ReactiveTcpSocketNio.Inspector socketInspector) {
		this.socketInspector = socketInspector;
		return this;
	}

	public ReactiveHttpClient withSocketSslInspector(ReactiveTcpSocketNio.Inspector socketSslInspector) {
