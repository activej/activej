 ...
 */
@ExplicitlyExposed
public final class CompareExpression implements Expression {
	private final List<Pair> pairs;

	public record Pair(Expression left, Expression right, boolean nullable) {}

	public CompareExpression(List<Pair> pairs) {
		this.pairs = pairs;
	}

	public static Builder builder() {
		return new CompareExpression(new ArrayList<>()).new Builder();
	}

	public final class Builder extends AbstractBuilder<Builder, CompareExpression> {
		private Builder() {}
		...
		public Builder with(Expression left, Expression right, boolean nullable) {
			checkNotBuilt(this);
			CompareExpression.this.pairs.add(new CompareExpression.Pair(left, right, nullable));
			return this;
		}

		@Override
		protected CompareExpression doBuild() {
			return CompareExpression.this;
		}
	}
