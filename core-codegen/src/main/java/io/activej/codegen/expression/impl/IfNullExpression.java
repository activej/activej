...
@ExplicitlyExposed
public final class IfNullExpression implements Expression {
	private final Expression expression;
	private final Expression expressionTrue;
	private final Expression expressionFalse;

	public IfNullExpression(Expression expression, Expression expressionTrue, Expression expressionFalse) {
