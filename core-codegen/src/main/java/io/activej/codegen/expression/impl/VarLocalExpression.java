 ...
 */
@ExplicitlyExposed
public final class VarLocalExpression implements LocalVariable {
	private static final int VOID = -1;
	public static final VarLocalExpression VAR_LOCAL_VOID = new VarLocalExpression(VOID);

	private final int local;

	public VarLocalExpression(int local) {
		this.local = local;
	}
