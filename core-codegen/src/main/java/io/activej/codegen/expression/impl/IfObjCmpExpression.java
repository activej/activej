 ...
 */
@ExplicitlyExposed
public final class IfObjCmpExpression implements Expression {
	...
	public IfObjCmpExpression(CompareOperation operation, Expression left, Expression right, Expression expressionTrue, Expression expressionFalse) {
		this.left = left;
		this.right = right;
