...
@ExplicitlyExposed
public final class IfNonNullExpression implements Expression {
	private final Expression expression;
	private final Expression expressionTrue;
	private final Expression expressionFalse;

	public IfNonNullExpression(Expression expression, Expression expressionTrue, Expression expressionFalse) {
