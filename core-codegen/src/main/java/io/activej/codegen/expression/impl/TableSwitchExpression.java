...
@ExplicitlyExposed
public final class TableSwitchExpression implements Expression {
	private final Expression value;
	private final int[] keys;
	private final Expression[] matchExpressions;
	private final Expression defaultExpression;

	public TableSwitchExpression(Expression value, int[] keys, Expression[] matchExpressions, Expression defaultExpression) {
		this.value = value;
		this.keys = keys;
