...
@ExplicitlyExposed
public final class IfZCmpExpression implements Expression {
	...
	public IfZCmpExpression(Expression value, CompareOperation operation, Expression expressionTrue, Expression expressionFalse) {
		this.value = value;
