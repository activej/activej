 ...
 */
@ExplicitlyExposed
public final class HashCodeExpression implements Expression {
	private final List<Expression> arguments;

	public HashCodeExpression(List<Expression> arguments) {
		this.arguments = arguments;
	}

	public static Builder builder() {
		return new HashCodeExpression(new ArrayList<>()).new Builder();
	}

	public final class Builder extends AbstractBuilder<Builder, HashCodeExpression> {
		private Builder() {}

		public Builder with(Expression expression) {
			checkNotBuilt(this);
			HashCodeExpression.this.arguments.add(expression);
			return this;
		}
		...
		@Override
		protected HashCodeExpression doBuild() {
			return HashCodeExpression.this;
		}
	}
