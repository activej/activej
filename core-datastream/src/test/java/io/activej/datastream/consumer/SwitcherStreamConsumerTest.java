...
public class SwitcherStreamConsumerTest {
	...
	public void testSwitchingToClosedStream() {
		...
		StreamConsumer<Integer> consumerClosed = StreamConsumers.closingWithError(expectedException);
...
//		assertClosedWithError(consumer1);
	...
	public void testSwitchingAfterSwitcherIsDone() {
		...
		await(StreamSuppliers.ofValues(1, 2, 3, 4).streamTo(switcher));
	...
	public void testSwitchingAfterSwitcherIsClosed() {
		...
		assertSame(expectedException, awaitException(StreamSuppliers.ofValues(1, 2, 3, 4).streamTo(switcher)));
