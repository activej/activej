...
public class ReactiveBlockingPutQueueTest {
	...
	public void testStream() throws InterruptedException {
		...
		TestSupplierBlockingPutQueueConsumer queue = new TestSupplierBlockingPutQueueConsumer(eventloop);
	...
	private final class TestSupplierBlockingPutQueueConsumer extends ReactiveBlockingPutQueue<Integer> {
		...
		public TestSupplierBlockingPutQueueConsumer(Eventloop eventloop) {
			super(eventloop, 8192);
		}
