...
final class Utils {
	...
	static ChunksBackupService backupServiceOfStorage(ReactiveAggregationChunkStorage<Long> storage) {
	...
	static ChunksCleanerService cleanerServiceOfStorage(ReactiveAggregationChunkStorage<Long> storage) {
	...
	private static void execute(ReactiveAggregationChunkStorage<Long> storage, AsyncRunnable runnable, String errorMessage) throws IOException {
		try {
