		...
		List<LogDiff<CubeDiff>> diffs1 = singletonList(
				LogDiff.of(
						...
						singletonList(
								CubeDiff.of(
										map(
												"campaign", AggregationDiff.of(set(
												...
												"advertiser-campaign", AggregationDiff.of(set(
								...
								CubeDiff.of(
										map(
												"campaign", AggregationDiff.of(
														...
														set(AggregationChunk.create(1L, asList("clicks", "impressions"), PrimaryKey.ofArray(12), PrimaryKey.ofArray(34), 10))),
												"advertiser-campaign", AggregationDiff.of(set(
