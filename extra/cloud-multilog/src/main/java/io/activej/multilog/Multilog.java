...
public final class Multilog<T> extends AbstractReactive
		implements IMultilog<T>, ReactiveJmxBeanWithStats, WithInitializer<Multilog<T>> {
	...
	private Multilog(Reactor reactor, IActiveFs fs, FrameFormat frameFormat, BinarySerializer<T> serializer,
	...
	public static <T> Multilog<T> create(Reactor reactor, IActiveFs fs, FrameFormat frameFormat, BinarySerializer<T> serializer,
			LogNamingScheme namingScheme) {
