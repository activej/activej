...
final class LogStreamChunker extends AbstractCommunicatingProcess implements ChannelInput<ByteBuf> {
	...
	public LogStreamChunker(CurrentTimeProvider currentTimeProvider, IActiveFs fs, LogNamingScheme namingScheme, String logPartition, UnaryOperator<ChannelConsumer<ByteBuf>> consumerTransformer) {
