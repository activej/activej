 ...
 */
public final class FilterableNodeSupplierOfId<T> extends AbstractNode {
	...
	public FilterableNodeSupplierOfId(int index, String id, WherePredicate predicate, int partitionIndex, int maxPartitions) {
		this(index, id, predicate, partitionIndex, maxPartitions, new StreamId());
	}

	public FilterableNodeSupplierOfId(int index, String id, WherePredicate predicate, int partitionIndex, int maxPartitions, StreamId output) {
		super(index);
		this.id = id;
