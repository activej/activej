...
public final class NodeCodecModule extends AbstractModule {
	...
	StreamCodec<Reduce> nodeReduce(
		StreamCodec<Comparator> comparatorStreamCodec, StreamCodec<Reducer> reducerStreamCodec,
	...
	@Provides
	@Subtype(1)
	StreamCodec<Upload> nodeUpload(StreamCodec<StreamSchema> streamSchemaStreamCodec) {
	...
	StreamCodec<Sort> nodeSort(
		StreamCodec<StreamSchema> streamSchemaStreamCodec, StreamCodec<Function> functionStreamCodec,
	...
	StreamCodec<Merge> nodeMerge(
		StreamCodec<Function> functionStreamCodec, StreamCodec<Comparator> comparatorStreamCodec
	) {
	...
	@Provides
	@Subtype(5)
	StreamCodec<Shard> nodeShard(StreamCodec<Function> functionStreamCodec) {
	...
	@Provides
	@Subtype(7)
	StreamCodec<Download> nodeDownload(StreamCodec<StreamSchema> streamSchemaStreamCodec) {
	...
	@Provides
	@Subtype(8)
	StreamCodec<Map> nodeMap(StreamCodec<Function> functionStreamCodec) {
	...
	@Provides
	@Subtype(10)
	StreamCodec<Filter> nodeFilter(StreamCodec<Predicate> predicateStreamCodec) {
