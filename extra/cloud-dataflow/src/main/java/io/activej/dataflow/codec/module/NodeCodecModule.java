...
import io.activej.serializer.stream.StructuredStreamCodec.CodecAndGetter;
...
final class NodeCodecModule extends AbstractModule {
	...
	StreamCodec<NodeReduce> nodeReduce(
		...
		StructuredStreamCodec<NodeReduce.Input> inputCodec = StructuredStreamCodec.create(NodeReduce.Input::new,
				NodeReduce.Input::getReducer, reducerStreamCodec,
				NodeReduce.Input::getKeyFunction, functionStreamCodec
		);
		return StructuredStreamCodec.create((a, b, c, d) -> new NodeReduce(a, b, c, d),
	...
	StreamCodec<NodeUpload> nodeUpload(
		...
		return StructuredStreamCodec.create(NodeUpload::new,
	...
	StreamCodec<NodeOffsetLimit> nodeOffsetLimit() {
		return StructuredStreamCodec.create(NodeOffsetLimit::new,
	...
	StreamCodec<NodeSort> nodeSort(
		...
		return StructuredStreamCodec.create(values -> new NodeSort(
						((int) values[0]),
	...
	StreamCodec<NodeMerge> nodeMerge(
		...
		return StructuredStreamCodec.create(NodeMerge::new,
	...
	StreamCodec<NodeShard> nodeShard(
		...
		return StructuredStreamCodec.create(NodeShard::new,
	...
	StreamCodec<NodeSupplierEmpty> nodeSupplierEmpty() {
		return StructuredStreamCodec.create(NodeSupplierEmpty::new,
	...
	StreamCodec<NodeDownload> nodeDownload(
		...
		return StructuredStreamCodec.create(NodeDownload::new,
				NodeDownload::getIndex, StreamCodecs.ofVarInt(),
				NodeDownload::getStreamSchema, streamSchemaStreamCodec,
				NodeDownload::getAddress, StructuredStreamCodec.create(InetSocketAddress::new,
	...
	StreamCodec<NodeMap> nodeMap(
		...
		return StructuredStreamCodec.create(NodeMap::new,
	...
	StreamCodec<NodeJoin> nodeJoin(
		...
		return StructuredStreamCodec.create(values -> new NodeJoin(
						((int) values[0]),
						((StreamId) values[1]),
						((StreamId) values[2]),
						((StreamId) values[3]),
	...
	StreamCodec<NodeFilter> nodeFilter(
		...
		return StructuredStreamCodec.create(NodeFilter::new,
	...
	StreamCodec<NodeConsumerOfId> nodeConsumerOfId() {
		return StructuredStreamCodec.create(NodeConsumerOfId::new,
	...
	StreamCodec<NodeSupplierOfId> nodeSupplierOfId() {
		return StructuredStreamCodec.create(NodeSupplierOfId::new,
	...
	StreamCodec<NodeUnion> nodeUnion() {
		return StructuredStreamCodec.create(NodeUnion::new,
	...
	StreamCodec<NodeReduceSimple> nodeReduceSimple(
		...
		return StructuredStreamCodec.create(NodeReduceSimple::new,
