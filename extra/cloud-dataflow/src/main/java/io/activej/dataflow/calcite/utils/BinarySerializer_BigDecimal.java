...
public final class BinarySerializer_BigDecimal implements BinarySerializer<BigDecimal> {
	private static final BinarySerializer_BigDecimal INSTANCE = new BinarySerializer_BigDecimal();

	private BinarySerializer_BigDecimal() {
	}

	public static BinarySerializer_BigDecimal getInstance() {
		return INSTANCE;
	}
