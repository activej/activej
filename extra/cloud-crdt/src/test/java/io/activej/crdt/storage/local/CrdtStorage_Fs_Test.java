...
public final class CrdtStorage_Fs_Test {
	private static final CrdtFunction<Set<Integer>> CRDT_FUNCTION = ignoringTimestamp(CrdtStorage_Fs_Test::union);
	...
	private static void testPickFilesForConsolidation(Set<String> expected, Map<String, Integer> fileToSizeMap) {
		...
		Set<String> filesForConsolidation = CrdtStorage_Fs.pickFilesForConsolidation(files);
