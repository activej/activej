...
public final class ClusterCrdtStorage<K extends Comparable<K>, S, P> extends AbstractReactive
	...
	private final StreamStatsBasic<CrdtData<K, S>> repartitionUploadStats = StreamStats.basic(reactor);
	private final StreamStatsDetailed<CrdtData<K, S>> repartitionUploadStatsDetailed = StreamStats.detailed(reactor);
