 ...
 */
public final class HttpFs extends AbstractReactive
		implements AsyncFs, WithInitializer<HttpFs> {
	private final AsyncHttpClient client;
	private final String url;

	private HttpFs(Reactor reactor, String url, AsyncHttpClient client) {
		super(reactor);
		this.url = url;
		this.client = client;
	}

	public static HttpFs create(Reactor reactor, String url, AsyncHttpClient client) {
		return new HttpFs(reactor, url.endsWith("/") ? url : url + '/', client);
	}
