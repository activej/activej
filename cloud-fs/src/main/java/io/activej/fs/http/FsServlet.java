 ...
 */
public final class FsServlet implements WithInitializer<FsServlet> {
	private FsServlet() {
	}
	...
	private static Promise<HttpResponse> rangeDownload(AsyncFs fs, boolean inline, String name, String rangeHeader) {
