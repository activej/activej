...
public final class TestLocalBlockingFileSystemInvariants {
	@Rule
	...
	private BlockingFileSystem first;
	private BlockingFileSystem second;
	...
	private static class DefaultBlockingFileSystem implements BlockingFileSystem {
		private final BlockingFileSystem peer;

		private DefaultBlockingFileSystem(BlockingFileSystem peer) {
			this.peer = peer;
		}
	...
	private void both(ConsumerEx<BlockingFileSystem> fsConsumer) {
		try {
